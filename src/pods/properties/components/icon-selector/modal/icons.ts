...
export const iconCollection: IconInfo[] = [
  ...
  },
  {
    ...
    filename: 'microsoftpowerpoint.svg',
    searchTerms: ['microsoft', 'powerpoint', 'office', 'presentation'],
    categories: ['IT'],
  },
  {
    name: 'Trim',
    filename: 'rectangledashed.svg',
    searchTerms: ['trim', 'rectangle', 'outline', 'border', 'shape'],
    categories: ['IT'],
  },
  {
    name: 'Rectangle Zero',
